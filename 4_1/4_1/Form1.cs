...
namespace _4_1
{
    public partial class Form1 : Form
    {
        ...
        {
            velocityControlBar.Value = Convert.ToInt32(inputSpeedTextbox.Text);
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (dataQueue.Count > 5)
            {
               ...
               else if (count == 2)
                {
                    ...
                    hzChart.Series[0].Points.AddXY(time, velocity);
                    time += tps;
                    if (j < 200)
                    {
                        j++;
                    ...
                    else                 //scroll through points in chart
                    {
                        ...
                        hzChart.Series[0].Points.RemoveAt(0);
                        hzChart.ChartAreas[0].RecalculateAxesScale();
                    }
