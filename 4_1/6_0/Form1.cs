...
namespace _6_0
{
    public partial class Form1 : Form
    {
        ...
        int EscapeByte = 0;
        int dutyCycleVal, dutyCycleVal2; // 16 bit value of duty cycle from -65535 to 65535
        ...
        double inputPosition, inputPosition2;
        ...
        //variable that stores the position errors or DC and stepper motor, scaled by Kp and Kp2.
        double errPosition, errPosition2, expectedPositionScalar;
        double Kp = -50;
        double Kp2 = -100; 
        void setPosition()
        {
            if (isInputSet)
            {
                ...
                errPosition2 = Kp2 * (inputPosition2 - expectedPositionScalar * position);
                ...
                //saturate PWM stepper motor
                if (errPosition2 >= 65535)
                {
                    dutyCycleVal2 = 65535;
                }
                else if (errPosition2 <= -65535)
                {
                    dutyCycleVal2 = -65535;
                }
                else
                {
                    dutyCycleVal2 = Convert.ToInt32(errPosition);
                }
        ...
        void sendPacket(int cmdSpecial)
        {
            ...
            else
            {
                ...
                DutyCycleHighBit = Math.Abs(dutyCycleVal2 / 256);
                DutyCycleLowBit = Math.Abs(dutyCycleVal2) % 256;
        ...
        private void velocityControlBar_ValueChanged(object sender, EventArgs e)
        {
            ...
            sendPacket(0); //Send DC Motor Packet
            sendPacket(1); //Send Stepper Motor Packet
        }
        ...
        private void positionInputButton_Click(object sender, EventArgs e)
        {
            ...
            inputPosition2 = Convert.ToDouble(positionInput2Textbox.Text);
            expectedPositionScalar = inputPosition / inputPosition2;
            isInputSet = true;
        }
